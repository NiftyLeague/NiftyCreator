...
public class EffectsController : MonoBehaviour
{
	...
	{
		Instantiate(instance.teleportSolo, pos + Vector3.forward * 3f, Quaternion.identity);
	}

	public static void CreateTeleportMewtwo(Vector3 pos)
	{
		Instantiate(instance.teleportMewtwo, pos + Vector3.forward * 3f, Quaternion.identity);
	}

	public static void CreateExplosion01(Vector3 pos)
	{
		Instantiate(instance.explosion01, pos + Vector3.forward * 3f, Quaternion.identity);
	}
	...
	internal static void CreateKnockedUpEffect(CharacterAnimator characterAnimator)
	{
		...
		kue.spriteRenderer.color = characterAnimator.primaryColor;
